...
import { PrismaService } from '@alpin11-coding-challenge/libs/api/data-access-db';
import { CreateOneBookArgs, FindUniqueBookArgs, UpdateOneBookArgs, DeleteOneBookArgs } from '@alpin11-coding-challenge/libs/api/generated-db-types';
